 ...
 */
// A 53 minute video uses  8 GB
let costofsixminutevideo = 150 * 6
let totalspaceiniphone = 8000
let fifthythreeminutvideo = 7950
let totalspace = fifthythreeminutvideo
