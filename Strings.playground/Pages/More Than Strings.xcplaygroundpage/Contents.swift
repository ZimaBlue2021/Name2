...
let Name = "Sam"
let savedupcash = "600"
let itemtheysaveupfor = "PS5"
let store = "best buy"
let emotion = "jubilant"
let sademotion = "defeated"
let fullsentece = "Today was a big day for \(Name) they had finally saved up \(savedupcash) dollars and were going to buy a \(itemtheysaveupfor), they went to \(store) feeling very \(emotion) but then they felt \(sademotion), They were all out of \(itemtheysaveupfor) "
